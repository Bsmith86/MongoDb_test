...
let connectionString = `mongodb+srv://${process.env.MONGOUSERNAME}:${process.env.MONGOPASSWORD}@mongobdtest.vsef73t.mongodb.net/FruitsDB?retryWrites=true&w=majority`
